...
import mapping.RecordTypeMapping;
...
public class SearchItemHandler extends DefaultHandler{
    ...
    /**
     * <p>When the parsing of Doc element is finished we fill in our array .
    ...
    /**
     * <p> extract the data receive from Rest Webservice response. </p>
     * @author artaud antoine
     */
    public void characters(char ch[], int start, int length) throws SAXException {
        ...
        if(bfrecordType){
            ...
            String recordType =  mRecordTypeCache.get(new String(ch, start, length));
            if(recordType!=null){
